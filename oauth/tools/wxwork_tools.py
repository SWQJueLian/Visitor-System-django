...
class BaseWXWorkApi:
    ...
    def __init__(self, coprid=None, app_secret=None):
        ...
        :param app_secret:
        """
        self._coprid = coprid or settings.WXWORK_COPRID
        self._app_secret = app_secret or settings.WXWORK_APP_SECRET
    ...
    def access_token(self):
        ...
        access_token = cache.get(self.CACHE_KEY, None)
    ...
    def refresh_access_token(self):
        ...
        cache.set(self.CACHE_KEY, access_token, timeout=expires - 60)
        return access_token
...
> 来访日期：<font color=\"warning\">{timezone.localtime(invite.visit_date).strftime('%Y-%m-%d %H:%M:%S')}</font>
> 
> 请您准备接待！"""
            },
...
# def get_basic_userinfo(code: str):
#     """
#     根据code获取用户基本信息
#     """
#     url = 'https://qyapi.weixin.qq.com/cgi-bin/user/getuserinfo'
#     data = {
#         'access_token': settings.TEMP_TOKEN,
#         "code": code
#     }
#     response: Response = requests.get(url, params=data)
#     json_data = response.json()
#
#     return json_data
#
#
# def get_detail_userinfo(userid: str):
#     """
#     根据userid获取用户详细信息
#     """
#     url = 'https://qyapi.weixin.qq.com/cgi-bin/user/get'
...
#
#
# def get_detail_department(userid: str):
#     """
#     获取部门详情
#     """
#     url = 'https://qyapi.weixin.qq.com/cgi-bin/department/get'
